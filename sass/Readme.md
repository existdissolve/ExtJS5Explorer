...
folder are mapped to the application's root namespace, 'ExtJS5Explorer'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtJS5Explorer"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJS5Explorer' in the same way
as `"ExtJS5Explorer/sass/src"`.
